...
The default OG image will be placed if a post does not specify the OG image. Though not required,asd OG image related to the post should be specify in the frontmatter. The recommended size for OG image is **_1200 X 640_** px.
